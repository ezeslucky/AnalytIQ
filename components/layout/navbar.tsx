...
<span className=' bg-clip-text bg-gradient-to-r from-white to-neutral-500 font-medium text-transparent text-xl'> AnalytIQ</span>
</Link>
<div className=" flex items-center gap-2">
    <Sheet>
        <SheetTrigger asChild>
<Button size="icon" className=' md:hidden bg-[#dd4e4e] hover:bg-[#e37979cb]  text-gray-300'>
<Menu size='24' />
